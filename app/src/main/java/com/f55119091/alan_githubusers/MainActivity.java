package com.f55119091.alan_githubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("F55119091_List of Users");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
